...
from app.api import auth, devices, schedules, control, images, unlock_requests, logs, scan_unlock, scan_bridge  # noqa
...
app.include_router(scan_unlock.router, prefix="/api")
app.include_router(scan_bridge.router)  # 扫码桥接页面（无 /api 前缀）
